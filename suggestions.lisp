...
;; to use this option, first dump the SOLR core with the following url http://localhost:8983/solr/suggestions/select?q=*%3A*&fq=status%3Acommitted&rows=1000000&wt=json&indent=false
